...
class DocumentSharingService {
  ...
  static Future<ShareResult> shareDocument(
    ...
    return result.status == ShareResultStatus.success ? ShareResult.success : ShareResult.failed;
  }
  ...
  static Future<ShareResult> shareAsText(Document document) async {
    ...
    final result = await Share.share(shareText, subject: document.filename);
    return result.status == ShareResultStatus.success ? ShareResult.success : ShareResult.failed;
  }
